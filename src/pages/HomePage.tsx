...
const HomePage = () => {
  ...
  return (
    <div className="gradient-bg cursor-none">
      {/* Fixed white circle "rug" in the background */}
      <div className="fixed rounded-full bg-[rgba(255,255,255,.5)] h-[100vh] w-[100vh] lg:h-[120vh] lg:w-[120vh] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0" />
      {!isTouchDevice() && <CustomCursor />}

      <div
        // ref={scrollContainerRef}
        // className="sm:h-screen sm:snap-y sm:snap-mandatory overflow-y-scroll scroll-smooth relative"
        className=""
      >
        <HeroSection />
        <AboutSection />
